...
public class Dev {
    ...
    public void avancarConteudo(){
        ...
        if (conteudo.isPresent()){
            ...
            System.out.println("Aluno não matriculado em nenhum conteudo");
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        Dev dev = (Dev) o;
        return Objects.equals(nome, dev.nome) && Objects.equals(conteudosIncritos, dev.conteudosIncritos) && Objects.equals(conteudosFinalizados, dev.conteudosFinalizados);
    }

    @Override
    public int hashCode() {
        return Objects.hash(nome, conteudosIncritos, conteudosFinalizados);
    }
}
